            ...
            <form onSubmit={submitHandler} className="container w-[40rem]">
                <div className="my-[2rem]">
                    ...
                    <input 
                        type="text" 
                        id="name"
                        className='mt-1 p-2 border bg-[#101011] text-white rounded w-3/4'
                ...
                <button disabled={isLoading} className="bg-pink-500 text-white px-4 py-2 rounded cursor-pointer my-[1rem]">{isLoading ? 'Registering..' : 'Register'}</button>
