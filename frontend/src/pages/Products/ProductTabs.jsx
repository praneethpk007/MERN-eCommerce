...
const ProductTabs = ({loadingProductReview, userInfo, submitHandler, rating, setRating, comment, setComment, product}) => {
    ...
    if(error) return <div>{error?.data?.message || error.message}</div>
            ...
            {activeTab === 1 && (
                <div className="mt-4">
                    {userInfo ? (
                        ...
                        >
                            <div className="my-2">
                                ...
                                <select 
                                    ...
                                    className="p-2 border rounded-lg xl:w-[40rem] text-block bg-[#0f0f10] text-white"
                                >
                            ...
                            <div className="my-2">
                                <label htmlFor="coment" className="block text-xl mb-2">Comment</label>
                                <textarea 
                                    id='comment' 
                                    rows='3' 
                                    required 
                        ...
                        <p>Please <Link to='/login' className="hover:underline">sign in</Link> to write a review.</p>
                    )}
                </div>
            )}
        </section>
