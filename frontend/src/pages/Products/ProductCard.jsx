    ...
    <div className="max-w-sm relative bg-[#1A1A1A] rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="p-5">
            <div className="flex flex-wrap justify-between">
                <h5 className="mb-2 text-large text-white dark:text-white">
                    {p?.name}
                </h5>
                <p className="font-semibold text-pink-500">
                    {p?.price?.toLocaleString('in-IN', {
                        style: "currency",
                        currency: "INR"
                    })}
                </p>
            ...
            <section className="flex justify-between items-center">
                <Link 
                    ...
                    rounded-lg hover:bg-pink-800 focus:ring-4 focus:outline-none focus:ring-pink-300 dark:bg-pink-600
