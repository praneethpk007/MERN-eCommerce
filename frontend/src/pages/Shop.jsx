...
import {setCategories, setProducts, setChecked} from "../redux/features/shop/shopSilce"
...
const Shop = () => {
  ...
  const categoriesQuery = useListCategoryQuery();
      ...
      <div className="container mx-auto">
        <div className="flex md:flex-row">
          <div className="bg-[#151515] p-3 mt-2 mb-2">
            <h2 className="h4 text-center bg-black rounded-full mb-2">
              Filter Categories
            </h2>
                ...
                <>
                  <div className="flex items-center mr-4 mb-5">
                    <input 
                      ...
                      className="w-4 h-4 text-pink-400 bg-gray-100 border-gray-300 focus:ring-pink-500 dark:focus:ring-pink-600 
          ...
          <div className="p-3">
            ...
            <div className="flex flex-wrap">
              {products.length === 0 ? (
                ...
                products?.map((p) => (
                  <div key={p._id} className="p-3 flex flex-wrap">
                    <ProductCard p={p}/>
                  </div>
                ))
              )}
